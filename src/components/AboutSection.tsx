...
const AboutSection = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Responsive",
      description:
        "Building applications that work seamlessly across all devices and screens.",
      accent: "violet",
      glow: "rgba(139, 92, 246, 0.12)",
    },
    {
  ...
  return (
    ...
    >
      <motion.div
        className="absolute top-20 -left-10 text-[12rem] md:text-[16rem] font-bold text-white/[0.015] pointer-events-none select-none leading-none"
        style={{
      ...
      <motion.div className="max-w-7xl mx-auto relative" ref={ref}>
        ...
        >
          ...
          >
            ...
            solutions that combine beautiful design with robust functionality.
          </motion.p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start mb-20">
          ...
          >
            ...
            >
              ...
              I create comprehensive solutions that not only look great but also
              perform exceptionally. My approach combines technical expertise
              with creative problem-solving to deliver products that users love.
            </motion.p>
            <motion.p
              variants={slideInLeft}
              className="text-muted-foreground leading-relaxed"
            >
              ...
              developers. I believe in continuous learning and staying ahead of
              industry trends.
            </motion.p>
            ...
            >
              {[
                ...
                <motion.div
                  key={i}
                  className="glass-effect rounded-xl p-4 text-center hover:border-violet-500/20 transition-all duration-300"
                  whileHover={{
                    y: -4,
            ...
            <div className="relative p-[1.5px] rounded-2xl overflow-hidden">
              ...
              <div className="bg-card rounded-2xl p-8 relative">
                ...
                <div className="space-y-4 border-t border-white/[0.06] pt-6">
                  ...
                  <div className="flex items-start justify-between text-sm">
                    ...
                    <div className="flex flex-col items-end gap-1.5">
                      {["AWS Cloud", "Machine Learning", "Full Stack Dev"].map(
                        (cert) => (
                          <span
                            key={cert}
                            className="text-[11px] bg-violet-500/10 text-violet-300 px-2 py-0.5 rounded border border-violet-500/20"
                          >
                            {cert}
                          </span>
                        ),
                ...
                <div className="mt-4 grid grid-cols-2 gap-3">
                  <a
                    href="#contact"
                    className="text-center py-2.5 rounded-lg bg-white text-slate-950 font-bold text-sm hover:bg-white/90 transition-colors shadow-[0_0_15px_rgba(255,255,255,0.1)]"
                  >
                    Hire Me
                  </a>
                  <button
                    className="text-center py-2.5 rounded-lg border border-white/10 text-white font-semibold text-sm hover:bg-white/5 transition-colors"
                    onClick={() => {
        ...
        >
          {features.map((feature, index) => (
            <motion.div key={index} variants={fadeUp}>
              <GlowCard
                className="rounded-2xl border border-white/[0.04] bg-card/40 hover:border-violet-500/20 transition-all duration-500"
