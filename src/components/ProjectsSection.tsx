  ...
  const projects = [
    {
      title: "DeepScanX",
      description:
        "AI Radiology & Pathology Assistant for rapid assessment of medical images.",
      image: "/DeepScanX.png",
    ...
    },
    {
      ...
      description:
        "Tournament website for registration with modern UI, payment integration, and admin dashboard.",
      image: "/Shuttleverse.png",
      technologies: [
        "React",
        "Node.js",
        "Supabase",
    ...
    },
    {
      ...
      description:
        "Intelligent voice-enabled assistant powered by semantic analysis and natural language processing with real-time speech recognition.",
      image: "/image.png",
      technologies: ["Python", "Firebase", "React", "LLM", "ElevenLabs"],
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=600&h=300&fit=crop",
    ...
    },
    {
      ...
      description:
        "A responsive portfolio website with smooth animations, dark mode support, and optimized performance.",
      image:
      ...
      demoLink: "https://aditya-singh-portfolio-website.vercel.app/",
      codeLink: "#",
      featured: false,
      year: "2026",
    },
            ...
            >
              <TiltCard>
                ...
                >
                  ...
                  >
                    <div
                      className="relative group rounded-2xl overflow-hidden border border-white/[0.04]"
                    ...
                    >
                      ...
                      <div
                        className="absolute top-4 left-4 px-3 py-1 rounded-full glass-effect text-xs text-violet-400"
                        style={{ fontFamily: "var(--font-mono)" }}
                      >
                        {project.year}
                      </div>
                  ...
                  >
                    <span
                      className="text-violet-400 text-xs tracking-wider uppercase"
                      style={{ fontFamily: "var(--font-mono)" }}
                    >
                      Featured Project
                    </span>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6 glass-effect rounded-xl p-5">
                      {project.description}
                    </p>
                    <div
                    ...
                    >
                      {project.technologies.map((tech, i) => (
                        <span
                          key={i}
                          className="px-3 py-1 text-xs text-violet-400 bg-violet-500/10 border border-violet-500/15 rounded-full"
                          style={{ fontFamily: "var(--font-mono)" }}
                        >
                          {tech}
                        </span>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {other.map((project, index) => (
              <motion.div
                ...
                whileHover={{
                  y: -8,
                  boxShadow: "0 20px 40px rgba(139,92,246,0.06)",
                }}
              >
                ...
                <h4
                  className="text-lg font-bold mb-2 group-hover:text-violet-400 transition-colors"
